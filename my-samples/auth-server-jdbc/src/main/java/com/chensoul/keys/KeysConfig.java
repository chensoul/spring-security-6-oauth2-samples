...
public class KeysConfig {
	...
	@Bean
	public OAuth2TokenGenerator<OAuth2Token> delegationOauth2TokenGenerator(JwtEncoder jwtEncoder,
	...
	@Bean
	public TextEncryptor textEncryptor(@Value("${jwk.persistence.password}") String password,
