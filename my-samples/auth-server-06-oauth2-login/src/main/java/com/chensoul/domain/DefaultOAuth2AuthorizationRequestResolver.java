...
public final class DefaultOAuth2AuthorizationRequestResolver implements OAuth2AuthorizationRequestResolver {
    ...
    public DefaultOAuth2AuthorizationRequestResolver(ClientRegistrationRepository clientRegistrationRepository,
        ...
        this.authorizationRequestMatcher = PathPatternRequestMatcher.withPathPatternParser(PathPatternParser.defaultInstance)
    ...
    private static String expandRedirectUri(HttpServletRequest request, ClientRegistration clientRegistration,
        ...
        String redirectUri = UriComponentsBuilder.fromUriString(clientRegistration.getRedirectUri())
                .buildAndExpand(uriVariables)
                .toUriString();
        //去掉 {registrationId}，统一地址
        return redirectUri.replace(clientRegistration.getRegistrationId(), "");
    }
