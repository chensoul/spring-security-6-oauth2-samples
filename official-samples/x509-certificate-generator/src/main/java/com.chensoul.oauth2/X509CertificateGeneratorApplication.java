...
import static com.chensoul.oauth2.BouncyCastleUtils.BC_PROVIDER;
...
public class X509CertificateGeneratorApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        writeCertificatePEMEncoded(rootCertificate, "./official-samples/x509-certificate-generator/generated/" + commonName + ".pem");
        writeKeystore(rootKeyPair, new Certificate[]{rootCertificate}, commonName,
                null, "./official-samples/x509-certificate-generator/generated/" + commonName + "-keystore.p12");
        ...
        writeCertificatePEMEncoded(caCertificate, "./official-samples/x509-certificate-generator/generated/" + commonName + ".pem");
        writeKeystore(caKeyPair, new Certificate[]{caCertificate, rootCertificate}, commonName,
                rootTrustedCertificate, "./official-samples/x509-certificate-generator/generated/" + commonName + "-keystore.p12");
        ...
        writeKeystore(demoClientKeyPair, new Certificate[]{demoClientCertificate, caCertificate, rootCertificate}, commonName,
                caTrustedCertificate, "./official-samples/demo-client/src/main/resources/keystore.p12");
        ...
        writeKeystore(selfSignedDemoClientKeyPair, new Certificate[]{selfSignedDemoClientCertificate}, alias,
                caTrustedCertificate, "./official-samples/demo-client/src/main/resources/keystore-self-signed.p12");
        ...
        writeKeystore(messagesResourceKeyPair, new Certificate[]{messagesResourceCertificate, caCertificate, rootCertificate}, commonName,
                trustedCertificates, "./official-samples/message-resource/src/main/resources/keystore.p12");
        ...
        writeKeystore(demoAuthorizationServerKeyPair, new Certificate[]{demoAuthorizationServerCertificate, caCertificate, rootCertificate}, commonName,
                trustedCertificates, "./official-samples/demo-authorizationserver/src/main/resources/keystore.p12");
    }
