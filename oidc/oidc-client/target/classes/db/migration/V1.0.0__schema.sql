...
VALUES ('messaging-client-oidc', 'client', 'client', 'client_secret_basic', 'authorization_code',
        'AuthServer', '{baseUrl}/login/oauth2/code/{registrationId}', 'openid,profile,email',
